...
Education:
1. BS Information Technology — Networking Technology, Batangas State University TNEU — Lipa Campus (2022–2026). Graduated Cum Laude.
2. Senior High School — STEM strand, Alitagtag Senior High School (2020–2022). Graduated With Honors and awarded Best in Research.
3. Junior High School, St. Bridget College Alitagtag Inc. (2016–2020). Awarded Best in Use of Technology.
...
Projects (share the backend repo link when someone asks to see code):
1. Mood Studios Web and Mobile Application (2026) — booking system for a photography studio in Bacoor, Cavite. React web, Flutter mobile, Node.js backend, MongoDB, PayMongo payments. Backend repo: https://github.com/mood-studios/moodstudios-backend
2. SafeBite: Smart Monitoring Platform for Food Spoilage (2025) — IoT food spoilage monitoring with AI-driven analysis. Lipa City. Backend repo: https://github.com/kayl10913/SafeBite_Server
3. Midwest Web and Mobile Application (2025) — admin dashboard with sales forecasting and analytics. Lipa City. Backend repo: https://github.com/aleshamarie/Midwest_Server
4. Unit Testing Generator with AI + Code Vulnerability Checker (2025) — AI unit test generation and vulnerability scanning. Batangas City. No public repo listed.
...
- Cum Laude — BS Information Technology, Batangas State University TNEU — Lipa Campus (2026)
- Dean's Lister — Batangas State University TNEU — Lipa Campus
- With Honors — Alitagtag Senior High School (2022)
- Best in Research — Alitagtag Senior High School (2022)
- Best in Use of Technology — St. Bridget College Alitagtag Inc. (2020)`;
